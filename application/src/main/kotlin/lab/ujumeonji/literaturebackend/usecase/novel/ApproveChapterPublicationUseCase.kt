...
@Component
@Transactional
class ApproveChapterPublicationUseCase(
    private val contributorService: ContributorService,
    private val novelService: NovelService,
) : UseCase<ApproveChapterPublicationUseCase.Request, ApproveChapterPublicationUseCase.Response> {
    override fun execute(
        ...
        // Only administrators (users with MAIN role) can approve chapter publications
        ...
        val approved =
            novel.approveChapterPublication(
