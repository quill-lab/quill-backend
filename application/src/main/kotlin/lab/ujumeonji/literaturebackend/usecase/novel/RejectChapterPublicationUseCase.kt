...
@Component
@Transactional
class RejectChapterPublicationUseCase(
    private val contributorService: ContributorService,
    private val novelService: NovelService,
) : UseCase<RejectChapterPublicationUseCase.Request, RejectChapterPublicationUseCase.Response> {
    override fun execute(
        ...
        // Only administrators (users with MAIN role) can reject chapter publications
        ...
        val rejected =
            novel.rejectChapterPublication(
